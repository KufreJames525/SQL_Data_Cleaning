...
### Data Cleaning Process Proper
```
SELECT * 
FROM layoffs;

--First thing to do is create a staging table. 
--This is the one we will work with to clean the data. We want a table with the raw data in case something happens
...
-- i) Using a row number to check for duplicate 
